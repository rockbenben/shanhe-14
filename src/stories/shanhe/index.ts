  ...
  endings: [
    {
      ...
      photo: {
        file: 'end-pen.jpg',
        credit: '在美中国报界记者（correspondents）群像，1921 年 12 月 11 日 · 美国国家照相公司（National Photo Company Collection）／美国国会图书馆（LOC，item 2016831879） · Wikimedia Commons · 公有领域（PD·1921 年华盛顿摄，非该场景/年代，用作『记者·秉笔十四年』的报人意境氛围照）',
    ...
    },
    {
      ...
      photo: {
        file: 'end-sword.jpg',
        credit: '中国士兵携械与工具徒步过怒江临时吊桥开赴前线（原桥两年前由中方炸断以阻日军），1944 年 7 月 15 日 · 摄影 T/Sgt. Schaifer／美国陆军通信兵（Signal Corps）SC 193045-S · Wikimedia Commons · 公有领域（PD-USGov-Army·怒江/滇西反攻战场，非黔南工事实拍，无尸体无惨状）',
    ...
    },
    {
      ...
      photo: {
        file: 'end-home.jpg',
        credit: '奉天驿（沈阳站）站前广场，一名旅人提行李独自走过，战前（1945 年前） · 佚名／满铁沿线明信片（hdl 123456789/27048） · Wikimedia Commons · 公有领域（PD-Japan-oldphoto·战前手工上色影像；与终章 ch12-d 为同站不同影像，对应『回到出发的月台……走出站去，像每一个还乡的人』，非该场景实拍）',
